...
%TODO:BDS: Add citations, get rid of dark layout on second slide.
\slide{unreal-structure}
\slide{unreal-structure-a}
%Treewidth 
...
%TODO:BDS: Need to cite https://www.sciencedirect.com/science/article/pii/S0022000019300418
\slide{random-models}

%TODO:BDS: Fix citation to standard style for this talk 
...
%TODO:BDS: Add citation 
\slide{wcol-counting}

%TODO:BDS: Change title, add citation, mention IBD work? Tweak graphics if needed. 
...
\slide{be-wcol-A}
\slide{be-wcol-B}
%TODO: Need to add observation that scolr(G) ≤ wcolr(G) ≤ (scolr(G))^r.
...
%TODO:BDS: check citation format
...
%TODO: Add property about number of back-neighbors. 
\slide{degeneracy-computation-C}

%TODO: Add citation Breen-McKay, Lavallee, Sullivan, EuJC 2023 (In Press)
\slide{hardness}

%TODO: Are these the right bounds for Dvorak??? We should have improved his approximation algorithm.
\slide{order-approx}
...
% TODO: Make this display things on slide.
% Bibliography

...
% BS: What about putting a version of this titled as Sparse Graph Classes right after FPT, then argue against things like treewidth/planarity, then show it again here with BE highlighted as being in the ''Goldilocks zone" with a call-back to the planets imagery??
% -- TODO: Replace BE by crossed-out shallow minor
% -- TODO: Can we use a labelled version -- at least for the first time we show it if we go with the above suggestion? (I found the hierarchy-labeled.svg in my files; it's in the slides folder)
...
%% Placeholder
%% 2018 PragueDocCourse/Networks4/pdfs/open-questions.pdf
